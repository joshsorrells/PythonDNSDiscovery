...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(prog="DNS_Discovery.py", epilog="DNS Zonetransfer Script", usage="DNS_Discovery.py [options] -d <DOMAIN>", prefix_chars='-', add_help=True)
    ...
    parser.add_argument('-v', action='version', version='DNS-Discovery - v1.0', help='Prints the version of DNS-Discovery.py')
